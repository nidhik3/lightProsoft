  ...
  <div style="background: url('assets/img/bg/service-1.jpeg') no-repeat center center/cover;"
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-xl-6 col-lg order-2 order-lg-1 mt-5 mt-lg-0" data-aos="fade-right">
          <div> <img src="assets/image/service2a.png" class="img-fluid" alt="" /></div>
        </div>
          ...
          <div>
            ...
            <ul class="aai-list-items mt-4">
              <li class="aai-list-item d-flex align-items-center">
                ...
                <span class="aai-list-item-text">Exceptional talent pool across domain, technology and management which can be leveraged for any kind of Healthcare project</span>
              </li>
              <li class="aai-list-item d-flex align-items-center">
                <svg
                  class="flex-shrink-0"
              ...
              <li class="aai-list-item d-flex align-items-center">
                ...
                <span class="aai-list-item-text">Prevailing culture of pioneering and imbibing emerging technologies</span>
              </li>
              <li class="aai-list-item d-flex align-items-center">
                <svg
                  class="flex-shrink-0"
                ...
                <span class="aai-list-item-text">Strategic alliances to deliver the maximum value to customers</span>
              </li>
              <li class="aai-list-item d-flex align-items-center">
                <svg
                  width="24"
                ...
                <span class="aai-list-item-text">Well proven implementation and project management skills</span>
              </li>
              <li class="aai-list-item d-flex align-items-center">
                <svg
                  width="24"
                ...
                <span class="aai-list-item-text">Global presence</span>
              </li>
              <li class="aai-list-item d-flex align-items-center">
                <svg
                  width="24"
                ...
                <span class="aai-list-item-text">Professional Strength</span>
              </li>
              <li class="aai-list-item d-flex align-items-center">
                <svg
                  width="24"
                ...
                <span class="aai-list-item-text">Cost effective solutions</span>
              </li>
              <li class="aai-list-item d-flex align-items-center">
                <svg
                  width="24"
                ...
                <span class="aai-list-item-text">High level employee retention policy</span>
              </li>
