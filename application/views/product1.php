                  ...
                  <ul class="aai-list-items mt-4">
                    <li class="aai-list-item d-flex align-items-center">
                      ...
                      <span class="aai-list-item-text"
                        >Exceptional talent pool across domain, technology and management which can be leveraged for any kind of Healthcare project</span
                      >
                    </li>
                    <li class="aai-list-item d-flex align-items-center">
                      <svg
                      ...
                      <span class="aai-list-item-text"
                        >Backed by Healthcare domain expertise and leadership</span
                      >
                    </li>
                    <li class="aai-list-item d-flex align-items-center">
                      <svg
                      ...
                      <span class="aai-list-item-text"
                        >Prevailing culture of pioneering and imbibing emerging technologies</span
                      >
                    </li> 
                     <li class="aai-list-item d-flex align-items-center">
                      <svg
                      ...
                      <span class="aai-list-item-text"
                        >Strategic alliances to deliver the maximum value to customers</span
                      >
                    </li>
                    <li class="aai-list-item d-flex align-items-center">
                      <svg
                      ...
                      <span class="aai-list-item-text"
                        >Well proven implementation and project management skills</span
                      >
                    </li> <li class="aai-list-item d-flex align-items-center">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                    ...
                    <li class="aai-list-item d-flex align-items-center">
                      ...
                      <span class="aai-list-item-text"
                        >High level employee retention policy</span
                      >
                    </li>
