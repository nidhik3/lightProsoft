...
<!-- Main Start -->
  ...
  <section class="aai-hero-one position-relative  whitebg ">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-10 col-xl-5 mt-md-5 mt-lg-0">
  ...
  <!--service -->
  <section class="aai-features paddingTop mspace paddingBottom lightblue">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-8">
          <div class="aai-section-title text-center mb-md-5  mb-4 ">
            <h2 class="section-title fontclr"><span class="gradient-text">Services</span> We Offer.</h2>
      ...
      <div class="text-center mt-1 pbmd--5" data-aos="fade-up" data-aos-delay="110">
  ...
  <section class="grey paddingTop mspace ">
  ...
  <!-- About Start -->
  <section class="aai-services mspace lightblue ">
    <div class="normals">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-xl-6 col-lg">
            <div>
              <h2 class="section-title mb-md-4 lightblk">
                About Us
              </h2>
              <p class="section-desc">
              ...
              <ul class="aai-list-items mt-md-4  mt-2">
          ...
          <div class="col-xl-6 col-lg mt-5 mt-lg-0" data-aos="fade-left">
            <div>
              <img src="assets/image/about.png" class="img-fluid" alt="" />
            </div>
          </div>
        </div>
      </div>
