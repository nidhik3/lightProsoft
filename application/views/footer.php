       ...
       <div class="aai-footer-navigation-widgets pb-4 py-80">
         ...
         <div class="row pt-5">
             ...
             <div class="aai-footer-info">
               ...
               <div class="info mt-4 col-md-12  row">
                 ...
                 <div class="email row col-md-12 m-0 pt-md-3 pt-2" style="align-items: center;">
                   <h6 class="col-md-2 col-2" style="font-weight: 700;"> <span class="d-flex align-items-center"><i
                         class="bi bi-globe-americas"></i>
                       &nbsp;</span></h6>
                   <p class="col-md-10 col-10 p-0"> admin@prosoft.org.in
                   </p>
                 </div>
                 <div class="address row col-md-12 m-0 pt-md-3 pt-2" style="align-items:top;">
                   <h6 class="col-md-2 col-2" style="font-weight: 700;"> <span class="d-flex align-items-center"><i class="bi bi-geo-alt"></i>
                     </span></h6>
           ...
           <div class="col-xl-8 col-lg-8 col-md-12 mt-5 mt-lg-0">
             <div class="row">
               <div
                 class="col-xl-3col-lg-4 col-md-4"
                 data-aos="fade-up"
                 data-aos-delay="500"
                 data-aos-duration="1500">
